...
class DSZeROModel(Model):
    def __init__(self, args: Namespace) -> None:
        ...
        if "zebra" in args.model_name:
            self.model = ZebraForCausalLM.from_pretrained(args.model_name)
        else:
            self.model = get_hf_model_class(args.model_class).from_pretrained(args.model_name)
